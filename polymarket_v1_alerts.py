...
class MarketWatcher:
    ...
    def __init__(
        ...
        *,
        ...
        self.swing_min_start_odds = swing_min_start_odds
    ...
    def _handle_price_change(self, p: dict) -> None:
        ...
        for pc in p.get("price_changes", []) or []:
            ...
            if start.odds < self.swing_min_start_odds:
                continue
            if start.odds <= 0:
                continue
...
def main() -> None:
    ...
    ap.add_argument("--swing-min-start-odds", type=float, default=0.01, help="Only fire swing alerts when the baseline (start) mid-odds is >= this value. Default 0.01 (1¢).")
    ...
    while True:
        ...
        swing_min_start_odds=args.swing_min_start_odds,
